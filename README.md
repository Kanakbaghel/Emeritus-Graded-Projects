...
| <img width="150" height="100" src="https://github.com/user-attachments/assets/94824ec9-f407-4e3d-879c-1a9201c158d1" />| **Bank Customer Churn Analysis** | Machine Learning | Techniques of unsupervised learning, Predictive Modeling, dimensionality reduction techniques, clustering algorithms, and unsupervised learning algorithms. | [🔗 View Repository](https://github.com/Kanakbaghel/Bank_Customer_Churn_Analysis) |
|<img width="150" height="200" alt="image" src="https://github.com/user-attachments/assets/a9d222e2-46b1-4271-9ed2-3c23a7161354" />| **Market Basket Analysis and Customer Segmentation** | Data Modelling |  We'll preprocess the data, handle missing values and inconsistencies, perform association rule mining, and cluster customers. Visualizations (e.g., histograms, scatter plots, PCA projections) enhance interpretability. This follows data science best practices: exploratory data analysis (EDA), feature engineering, model evaluation, and business-oriented recommendations. | [🔗 View Repository](https://github.com/Kanakbaghel/Market_Basket_Analysis_and_Customer_Segmentation) |
